...
function update_todo_meter(){
  var todo_meter_percentage = ((finished_todo_items) / (finished_todo_items + $("div.todo_item_list div.todo_item").length)) * 100;
